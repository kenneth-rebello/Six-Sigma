    ...
    <div className="report-item row">
      ...
      <Modal
        ...
        <Fragment>
          ...
          <span>
            Reported On:
            <Moment format="DD/MM/YYYY">{report.reported_on}</Moment>
          </span>
        </Fragment>
      </Modal>
      ...
      <Modal
        ...
        <form onSubmit={e => Submitter(e)}>
          ...
          <br />
          <span>
            By saving this report (permanently) you are acknowledging that this
            report is legitimate and this will affect the concerned users
            credibility
          </span>
        </form>
      </Modal>
